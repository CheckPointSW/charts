...
{{- if has .Values.platform (list "kubernetes" "tanzu" "openshift" "openshift.v3" "eks" "eks.bottlerocket" "gke.cos" "k3s" "gke.autopilot") -}}
{{- else -}}
{{- $err := printf "\n\nERROR: Invalid platform: %s (should be one of: 'kubernetes', 'tanzu', 'openshift', 'openshift.v3', 'eks', 'eks.bottlerocket', 'gke.cos', 'k3s', 'gke.autopilot')"  .Values.platform -}}
{{- fail $err -}}
{{- end -}}
{{- end -}}
