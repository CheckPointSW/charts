...
| `addons.imageScan.daemon.tag`                              | Specify image tag for the agent                                 |`2.14.0-openshift`                                           |
...
| `addons.imageScan.daemon.shim.tag`                         | Specify image tag for the shim container                        |`2.14.0-openshift`                                           |
...
| `addons.imageScan.engine.tag`                              | Specify image tag for the agent                                 |`2.14.0-openshift`                                           |
...
| `addons.imageScan.list.tag`                                | Specify image tag for the agent                                 |`2.14.0-openshift`                                          |
