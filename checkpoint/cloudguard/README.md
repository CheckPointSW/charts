...
| `addons.imageScan.daemon.tag`                              | Specify image tag for the agent                                 |`2.9.0`                                           |
...
| `addons.imageScan.daemon.shim.tag`                         | Specify image tag for the shim container                        |`2.9.0`                                           |
...
| `addons.imageScan.engine.tag`                              | Specify image tag for the agent                                 |`2.9.0`                                           |
...
| `addons.flowLogs.daemon.tag`                               | Specify image tag for the agent                                 |`0.6.1`                                           |
...
| `addons.admissionControl.policy.tag`                       | Specify image tag for the agent                                 |`1.0.3`                                           |
...
| `addons.admissionControl.enforcer.tag`                     | Specify image tag for the agent                                 |`1.3.2`                                           |
...
| `addons.runtimeProtection.policy.tag`                      | Specify image tag for the agent                                 |`1.1.0`                                           |
