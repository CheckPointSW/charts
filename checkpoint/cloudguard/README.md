...
| `inventory.agent.tag`                                      | Specify image tag for the agent                                 | `1.3.2`                                          |
...
| `addons.imageScan.daemon.tag`                              | Specify image tag for the agent                                 |`2.3.0`                                           |
...
| `addons.imageScan.daemon.shim.tag`                         | Specify image tag for the shim container                        |`2.3.0`                                           |
...
| `addons.imageScan.engine.tag`                              | Specify image tag for the agent                                 |`2.3.0`                                           |
...
| `addons.runtimeProtection.daemon.tag`                      | Specify image tag for the agent                                 |`0.0.645-nfq`                                         |
