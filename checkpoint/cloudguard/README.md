...
| `inventory.agent.tag`                                      | Specify image tag for the agent                                 | `1.4.3`                                          |
...
| `addons.imageScan.daemon.tag`                              | Specify image tag for the agent                                 |`2.5.0`                                           |
...
| `addons.imageScan.daemon.shim.tag`                         | Specify image tag for the shim container                        |`2.5.0`                                           |
...
| `addons.imageScan.engine.tag`                              | Specify image tag for the agent                                 |`2.5.0`                                           |
...
| `addons.admissionControl.policy.tag`                       | Specify image tag for the agent                                 |`1.0.2`                                           |
...
| `addons.admissionControl.enforcer.tag`                     | Specify image tag for the agent                                 |`1.3.1`                                           |
