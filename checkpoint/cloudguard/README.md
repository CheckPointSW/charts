...
| `platform`                                                 | Kubernetes platform (kubernetes/tanzu/openshift/openshift.v3/eks/eks.bottlerocket/gke.cos/k3s/gke.autopilot) overriding auto-detection | `kubernetes`                                |
