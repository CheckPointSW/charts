...
| `platform`                                                 | Kubernetes platform (kubernetes/tanzu/openshift/openshift.v3/eks/eks.bottlerocket) overriding auto-detection | `kubernetes`                                |
...
| `addons.admissionControl.enforcer.tag`                     | Specify image tag for the agent                                 |`2.2.1`                                           |
